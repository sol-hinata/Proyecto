...
namespace proyect.Models
{
    ...
    partial void OnLastActivityDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_karma", Storage="_karmas", ThisKey="UserId", OtherKey="UserId")]
	...
	public partial class curso : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Data.Linq.Binary _detalle;
    ...
    partial void OnfechaChanging(System.DateTime value);
    partial void OnfechaChanged();
    partial void OndetalleChanging(System.Data.Linq.Binary value);
    partial void OndetalleChanged();
    partial void OnpuntuacionChanging(int value);
    partial void OnpuntuacionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_detalle", DbType="VarBinary(1000) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary detalle
		{
			get
			{
				return this._detalle;
    ...
    partial void OnUserIdChanging(System.Guid value);
    partial void OnUserIdChanged();
    partial void OnidKarmaChanging(int value);
    partial void OnidKarmaChanged();
    partial void OndetalleChanging(string value);
    partial void OndetalleChanged();
    ...
    partial void OnfechaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idKarma", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int idKarma
		{
			get
			{
				return this._idKarma;
			}
			set
			{
				if ((this._idKarma != value))
				{
					this.OnidKarmaChanging(value);
					this.SendPropertyChanging();
					this._idKarma = value;
					this.SendPropertyChanged("idKarma");
					this.OnidKarmaChanged();
				}
			}
		}
    ...
    partial void OnfechaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_articulo", Storage="_articulos", ThisKey="idPublicacion", OtherKey="idPublicacion")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_curso", Storage="_cursos", ThisKey="idPublicacion", OtherKey="idPublicacion")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_libro", Storage="_libros", ThisKey="idPublicacion", OtherKey="idPublicacion")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_reporte", Storage="_reportes", ThisKey="idPublicacion", OtherKey="idPublica")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_tutorial", Storage="_tutorials", ThisKey="idPublicacion", OtherKey="idPublicacion")]
    ...
    partial void OnidPublicaChanging(int value);
    partial void OnidPublicaChanged();
    partial void OndescripcionChanging(string value);
    partial void OndescripcionChanged();
    partial void OnfechaChanging(System.DateTime value);
    partial void OnfechaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idPublica", DbType="Int NOT NULL")]
		public int idPublica
		{
			get
			{
				return this._idPublica;
			}
			set
			{
				if ((this._idPublica != value))
				{
					if (this._publicacion.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnidPublicaChanging(value);
					this.SendPropertyChanging();
					this._idPublica = value;
					this.SendPropertyChanged("idPublica");
					this.OnidPublicaChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="publicacion_reporte", Storage="_publicacion", ThisKey="idPublica", OtherKey="idPublicacion", IsForeignKey=true)]
		public publicacion publicacion
		{
			get
			{
			...
			set
			{
							...
							|| (this._publicacion.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._idPublica = value.idPublicacion;
					}
					else
					{
						this._idPublica = default(int);
					}
					this.SendPropertyChanged("publicacion");
				}
			}
